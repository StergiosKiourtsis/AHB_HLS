...
`example2` : In this example we have a a 2 master 3 slave connection. Both master and slave modules are custom and we design them to try all the possibilities. And in this example the top module
