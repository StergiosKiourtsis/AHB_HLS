           ...
           if (insn == 0x0000006f) {
            ...
            case OPC_LW:
                ...
                default:
                    ...
                    #endif
                    SC_REPORT_ERROR(sc_object::name(), "Unimplemented LOAD instruction 599");
                    break;
                }
            ...
            case OPC_SW:
                ...
                default:
                    ...
                    debug_dout_t.st = "NO_STORE";
                    #endif
                    SC_REPORT_ERROR(sc_object::name(), "Unimplemented STORE instruction 644");
                    break;
                }
                output.alu_op = ALUOP_ADD;
            ...
            case OPC_ADDI: // OP-IMM instructions (arithmetic and logical operations on immediates): ADDI, SLTI, SLTIU, XORI, ORI, ANDI, SLLI, SRLI, SRAI
                ...
                if (insn.range(31, 25) == FUNCT7_SRAI && insn.range(14, 12) == FUNCT3_SRAI) {
                    ...
                    default:
                        ...
                        #endif
                        SC_REPORT_ERROR(sc_object::name(), "Unimplemented ALUOP_IMM instruction 745");
                        break;
                    }
                }
                output.regwrite = 1;
            ...
            case OPC_ADD: // R-type instructions: ADD, SLL, SLT, SLTU, XOR, SRL, OR, AND, SUB, SRA, MUL, MULH, MULHSU, MULHU, DIV, DIVU, REM, REMU.
                ...
                case FUNCT7_ADD: // ADD, SLL, SLT, SLTU, XOR, SRL, OR, AND
                    ...
                    default:
                        ...
                        debug_dout_t.alu_op = "ALUOP_NULL";
                        #endif
                        SC_REPORT_ERROR(sc_object::name(), "Unimplemented ALUOP_ADD instruction 846");
                        break;
                    }
                    break;
                case FUNCT7_SUB: // SUB, SRA
                    ...
                    default:
                        ...
                        debug_dout_t.alu_op = "ALUOP_NULL";
                        #endif
                        SC_REPORT_ERROR(sc_object::name(), "Unimplemented ALUOP_SUB instruction 872");
                        break;
                    }
                    break;
                ...
                case FUNCT7_MUL: // MUL, MULH, MULHSU, MULHU, DIV, DIVU, REM, REMU
                    ...
                    default:
                        ...
                        debug_dout_t.alu_op = "ALUOP_NULL";
                        #endif
                        SC_REPORT_ERROR(sc_object::name(), "Unimplemented ALUOP_MUL instruction 941");
                        break;
                    }
                    break;
                    #endif
                default:
                    ...
                    debug_dout_t.alu_op = "ALUOP_NULL";
                    #endif
                    SC_REPORT_ERROR(sc_object::name(), "Unimplemented ALUOP instruction 952");
                    break;
                }
                break;
            ...
            case OPC_SYSTEM:
                ...
                default:
                    ...
                    debug_dout_t.alu_op = "ALUOP_NULL";
                    #endif
                    SC_REPORT_ERROR(sc_object::name(), "Unimplemented SYSTEM instruction 1067");
                    break;
                }
                break;
            ...
            default: // illegal instruction
                ...
                SC_REPORT_ERROR(sc_object::name(), "Unimplemented instruction 1095");
                break;
